...
static SEGGER_RTT_CB _SEGGER_RTT  = {
  ...
  {{ "Terminal", &_acUpBuffer[0],   sizeof(_acUpBuffer),   0, 0, SEGGER_RTT_MODE_NO_BLOCK_SKIP }},  // Неблокирующий вывод с потерей данных
//  {{ "Terminal", &_acUpBuffer[0],   sizeof(_acUpBuffer),   0, 0, SEGGER_RTT_MODE_BLOCK_IF_FIFO_FULL }}, // Раскоментировать если нужен блокирующий вывод без потери данных
